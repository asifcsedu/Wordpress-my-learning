...
class Search {
  ...
  constructor() {
    ...
    this.searchField = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term"); //the search box
    this.resultsDiv = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__results"); //HTML content below the search bar inside the overlay
  ...
  keyPressDispatcher(e) {
    ...
    if (e.keyCode == 83 && !this.isOverlayOpen) {
      //if the 's' key has been pressed and overlay is NOT already open
      if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus'))
        //only if another input or textarea is currently NOT in focus
        this.openOverlay(); //show the overlay search box
    }
    if (e.keyCode == 27 && this.isOverlayOpen) {
      //if the 'ESC' key has been pressed and released
      this.closeOverlay();
    }
  }
  typingLogic() {
    if (this.searchField.val() != this.previousSearchQuery) {
      //if the search string changes
