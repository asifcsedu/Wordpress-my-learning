...
function universityMapKey($api){
  $api['key'] = 'AIzaSyAHd5giFT_pxxWHWASk-1HuPl6r1y3ouqA';
  return $api;
}
...
function university_files() {
  wp_enqueue_script('google-map', '//maps.googleapis.com/maps/api/js?key=AIzaSyAHd5giFT_pxxWHWASk-1HuPl6r1y3ouqA', NULL, '1.0', true);  
